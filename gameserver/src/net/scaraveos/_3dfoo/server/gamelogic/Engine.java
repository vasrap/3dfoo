...
public class Engine {
	...
	private FastMap<String, FastMap<String, Double>> playerUpdates = null;
	...
	public Engine(TokenServer tokenServer) {
		...
		this.playerUpdates = new FastMap<String, FastMap<String, Double>>();
	 ...
	 * @param message 
	 */
	public void setInsertPlayer(Map message, WebSocketConnector connector, TokenServer tokenServer) {
		String oauthNetwork = (String) message.get("oauthNetwork");
		String oauthToken = (String) message.get("oauthToken");
		String oauthTokenSecret = (String) message.get("oauthTokenSecret");
	 ...
	 * @param message 
	 */
	public void setRemovePlayer(WebSocketConnector connector, TokenServer tokenServer) {
	 ...
	 * @param message 
	 */
	public void setUpdatePlayer(Map message, WebSocketConnector connector, TokenServer tokenServer) {
		String connectorId = connector.getId();
		...
		try {
			...
			if (
				...
				FastMap clickedPlayerPositionMap = this.playerUpdates.get(clickId);
		...
		this.playerUpdates.put(id, (FastMap) message);
	}
	 ...
	 * @return 
	 */
	public FastMap<String, Integer> getStartingPosition(String id) {
	 ...
	 * @return 
	 */
	public FastMap<String, FastMap<String, Double>> getPlayerUpdates() {
	...
	public Token getDefsToken(String id) {
		...
		defsMap.put("position", this.getStartingPosition(id));
